...
Реализованна (частично) библиотека string.h с собственной реализацией функции sprintf на языке программирования Си.
Также дополнительно реализованы 4 функции обработки строк из С#
